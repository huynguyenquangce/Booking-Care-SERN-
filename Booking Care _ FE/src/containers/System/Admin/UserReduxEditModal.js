...
import "./UserReduxEditModal.scss";
import Lightbox from "react-image-lightbox";
import "react-image-lightbox/style.css"; // This only needs to be imported once in your app
import CommonUtils from "../../../utils/CommonUtils";
class UserReduxEditModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      genderArr: [],
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (prevProps.userEdit !== this.props.userEdit) {
      let arrUserEditor = this.props.userEdit;
      let imageBase64 = "";
      if (arrUserEditor.image) {
        imageBase64 = new Buffer(arrUserEditor.image, "base64").toString(
          "binary"
        );
      }
      this.setState({
        id: arrUserEditor.id,
        email: arrUserEditor.email,
        password: "1233213123",
        firstName: arrUserEditor.firstName,
        lastName: arrUserEditor.lastName,
        address: arrUserEditor.address,
        phoneNumber: arrUserEditor.phoneNumber,
        gender: arrUserEditor.gender,
        position: arrUserEditor.positionId,
        role: arrUserEditor.roleid,
  ...
  render() {
    ...
    // let userEditInfo = this.state.arrUserEdit;
    return (
      <Modal
        isOpen={isOpen}
        toggle={() => {
...
export default connect(mapStateToProps, mapDispatchToProps)(UserReduxEditModal);
